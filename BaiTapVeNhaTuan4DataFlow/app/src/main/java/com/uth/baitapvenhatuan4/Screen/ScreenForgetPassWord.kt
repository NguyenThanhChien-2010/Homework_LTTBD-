...
fun ScreenForgetPassWord(navController: NavHostController, sharedViewModel: SharedViewModel) {
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            textStyle = LocalTextStyle.current.copy(color = Color.Black) // 🔹 Màu chữ nhập vào
        )
        ...
        Button(
            ...
            colors = ButtonDefaults.buttonColors(
                containerColor = Color(0xFF419EFF) // 🔹 Màu nút xanh
            )
        ) {
            Text(
                text = "Next",
